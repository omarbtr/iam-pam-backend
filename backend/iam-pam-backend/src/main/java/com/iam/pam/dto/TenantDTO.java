...
public class TenantDTO {
    ...
    public static class CreateRequest {
        ...
        @Min(value = 1, message = "Max resources must be at least 1")
        ...
        public Integer getMaxResources() { return maxResources; }
        public void setMaxResources(Integer maxResources) { this.maxResources = maxResources; }
    ...
    /**
     * Mise à jour de la période de rétention des logs (tenant-admin)
     */
    public static class RetentionUpdateRequest {
        @NotNull(message = "Retention days is required")
        private Integer retentionDays;

        public RetentionUpdateRequest() {}
    ...
    public static class Response {
        ...
        private Integer maxResources;
        private Integer currentResources;
        ...
        public Integer getCurrentResources() { return currentResources; }
        public void setCurrentResources(Integer currentResources) { this.currentResources = currentResources; }
