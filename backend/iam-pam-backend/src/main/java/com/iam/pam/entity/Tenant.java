...
public class Tenant {
    ...
    // Nombre maximum de ressources autorisées (null = illimité)
    @Column(name = "max_resources")
    private Integer maxResources;

    // Durée de rétention des journaux d'audit en jours (7, 14 ou 30)
    @Column(name = "audit_log_retention_days", columnDefinition = "integer NOT NULL DEFAULT 30")
    private Integer auditLogRetentionDays = 30;

    @Column(name = "is_active")
    private Boolean isActive = true;

    // Nom d'utilisateur du tenant-admin courant (1 seul par tenant)
