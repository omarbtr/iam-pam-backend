...
public class ResourceService {
    ...
    public ResourceDTO.Response create(ResourceDTO.Request dto, String username) {
        ...
        resource.setCredentialUsername(dto.getCredentialUsername());
        resource.setCredentialPassword(dto.getCredentialPassword());
        resource.setCredentialPrivateKey(dto.getCredentialPrivateKey());
    ...
    public ResourceDTO.Response update(Long id, ResourceDTO.Request dto, String username) {
        ...
        resource.setPort(dto.getPort());
        resource.setDescription(dto.getDescription());
        if (dto.getCredentialUsername() != null) resource.setCredentialUsername(dto.getCredentialUsername());
        if (dto.getCredentialPassword() != null) resource.setCredentialPassword(dto.getCredentialPassword());
        if (dto.getCredentialPrivateKey() != null) resource.setCredentialPrivateKey(dto.getCredentialPrivateKey());
    ...
    private ResourceDTO.Response toResponse(Resource resource) {
        ResourceDTO.Response r = new ResourceDTO.Response();
        r.setId(resource.getId());
        r.setName(resource.getName());
        r.setType(resource.getType());
        r.setHost(resource.getHost());
        r.setPort(resource.getPort());
        r.setDescription(resource.getDescription());
        r.setTenantId(resource.getTenantId());
        r.setIsActive(resource.getIsActive());
        r.setCreatedAt(resource.getCreatedAt());
        r.setCredentialUsername(resource.getCredentialUsername());
        r.setHasPassword(resource.getCredentialPassword() != null && !resource.getCredentialPassword().isBlank());
        r.setHasPrivateKey(resource.getCredentialPrivateKey() != null && !resource.getCredentialPrivateKey().isBlank());
        return r;
    }
}